    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color:#1A202C">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('entreprise.create')}}">Ajouter</a>
                        </li>
                        <li class="nav-item">
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-danger danger:text-gray-500 underline"></a>
                    @else
                ...
                <tbody >
                    @foreach ($entreprises as $entreprise)
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ route('entreprise.edit', ['entreprise' => $entreprise]) }}">
                                    <button class="btn btn">
